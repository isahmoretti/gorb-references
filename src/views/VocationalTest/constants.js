...
export const RESULT_CONTENT = {
    a: {
        ...
        courses: [
            { name: 'Biblioteconomia', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-biblioteconomia.png' },
            { name: 'Filosofia', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-filosofia.png' },
            { name: 'Ciências Sociais', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-ciencias-sociais.png' },
            { name: 'História', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-historia.png' },
            { name: 'Geografia', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-geografia.png' },
            { name: 'Letras', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-letras.png' },
            { name: 'Jornalismo', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-jornalismo.png' },
            { name: 'Pedagogia', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-pedagogia.png' },
            { name: 'Relações Públicas', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-relacoes-publicas.png' },
            { name: 'Rádio, Tv e Internet', imgPath: 'Comunicativo/Desktop-resultado-comunicativo-radio-tv-internet.png' },
        ]
    },
    b: {
        name: 'O RACIONAL',
        ...
        courses: [
            { name: 'Administração', imgPath: 'Racional/Desktop-resultado-racional-administracao.png' },
            { name: 'Análise de Sistemas', imgPath: 'Racional/Desktop-resultado-racional-analise-de-sistemas.png' },
            { name: 'Astronomia', imgPath: 'Racional/Desktop-resultado-racional-astronomia.png' },
            { name: 'Biomedicina', imgPath: 'Racional/Desktop-resultado-racional-biomedicina.png' },
            { name: 'Ciência da Computação', imgPath: 'Racional/Desktop-resultado-racional-ciencia-da-computacao.png' },
            { name: 'Ciências Atuariais', imgPath: 'Racional/Desktop-resultado-racional-ciencias-atuariais.png' },
            { name: 'Contabilidade', imgPath: 'Racional/Desktop-resultado-racional-contabilidade.png' },
            { name: 'Economia', imgPath: 'Racional/Desktop-resultado-racional-economia.png' },
            { name: 'Estatística', imgPath: 'Racional/Desktop-resultado-racional-estatistica.png' },
            { name: 'Engenharia Civil', imgPath: 'Racional/Desktop-resultado-racional-engenharia-civil.png' },
            { name: 'Engenharia de Produção', imgPath: 'Racional/Desktop-resultado-racional-engenharia-de-producao.png' },
            // { name: 'Engenharia Química', imgPath: '' },
            { name: 'Engenharia de Software', imgPath: 'Racional/Desktop-resultado-racional-engenharia-de-software.png' },
            { name: 'Marketing', imgPath: 'Racional/Desktop-resultado-racional-marketing.png' },
            { name: 'Matemática Industrial', imgPath: 'Racional/Desktop-resultado-racional-matematica-industrial.png' },
        ],
    },
    c: {
        name: 'O PRÁTICO',
        ...
        courses: [
            { name: 'Artes Cênicas', imgPath: 'Pratico/Desktop-resultado-pratico-artes-cenicas.png' },
            { name: 'Agronomia', imgPath: 'Pratico/Desktop-resultado-pratico-agronomia.png' },
            { name: 'Dança', imgPath: 'Pratico/Desktop-resultado-pratico-danca.png' },
            { name: 'Educação Física', imgPath: 'Pratico/Desktop-resultado-pratico-educacao-fisica.png' },
            { name: 'Estética', imgPath: 'Pratico/Desktop-resultado-pratico-estetica.png' },
            { name: 'Gastronomia', imgPath: 'Pratico/Desktop-resultado-pratico-gastronomia.png' },
            { name: 'Piloto de Avião', imgPath: 'Pratico/Desktop-resultado-pratico-piloto-de-aviao.png' },
            { name: 'Piloto de Drones', imgPath: 'Pratico/Desktop-resultado-pratico-piloto-de-de-drones.png' },
            { name: 'Zootecnia', imgPath: 'Pratico/Desktop-resultado-pratico-zootecnia.png' },
        ],
    },
    d: {
        name: 'O CRIATIVO',
        ...
        courses: [
            { name: 'Arquitetura e Urbanismo', imgPath: 'Criativo/Desktop-resultado-criativo-arquitetura.png' },
            { name: 'Artes Visuais', imgPath: 'Criativo/Desktop-resultado-criativo-artes-visuais.png' },
            { name: 'Cinema', imgPath: 'Criativo/Desktop-resultado-criativo-cinema.png' },
            { name: 'Desenho Industrial', imgPath: 'Criativo/Desktop-resultado-criativo-desenho-industrial.png' },
            { name: 'Design de Games', imgPath: 'Criativo/Desktop-resultado-criativo-design-de-games.png' },
            { name: 'Design Gráfico', imgPath: 'Criativo/Desktop-resultado-criativo-design-grafico.png' },
            { name: 'Moda', imgPath: 'Criativo/Desktop-resultado-criativo-moda.png' },
            { name: 'Multimídia', imgPath: 'Criativo/Desktop-resultado-criativo-multimidia.png' },
            // { name: 'Museologia', imgPath: '' },
            { name: 'Artes Plásticas', imgPath: 'Criativo/Desktop-resultado-criativo-artes-plasticas.png' },
        ],
    },
    e: {
        name: 'O SOCIÁVEL',
        ...
        author: 'Marie Curie',
        courses: [
            { name: 'Direito', imgPath: 'Sociavel/Desktop-resultado-sociavel-direito.png' },
            { name: 'Publicidade e Propaganda', imgPath: 'Sociavel/Desktop-resultado-sociavel-publicidade.png' },
            { name: 'Recursos Humanos', imgPath: 'Sociavel/Desktop-resultado-sociavel-recursos-humanos.png' },
            { name: 'Relações Internacionais', imgPath: 'Sociavel/Desktop-resultado-sociavel-relacoes-internacionais.png' },
            { name: 'Psicologia', imgPath: 'Sociavel/Desktop-resultado-sociavel-psicologia.png' },
            { name: 'Medicina', imgPath: 'Sociavel/Desktop-resultado-sociavel-medicina.png' },
            { name: 'Enfermagem', imgPath: 'Sociavel/Desktop-resultado-sociavel-enfermagem.png' },
            { name: 'Fonoaudiologia', imgPath: 'Sociavel/Desktop-resultado-sociavel-fonoaudiologia.png' },
            { name: 'Odontologia', imgPath: 'Sociavel/Desktop-resultado-sociavel-odontologia.png' },
            { name: 'Terapia Ocupacional', imgPath: 'Sociavel/Desktop-resultado-sociavel-terapia-ocupacional.png' },
        ],
    },
}