          ...
          <form style={{ maxWidth: 1000 }} onSubmit={props.handleSubmit}>
            <Actions>
              <Title>
                ...
                <span>
                  Inclui certidão de nascimento, certidão de casamento, certidão
                  de óbito, carteira de trabalho, passaporte, título de eleitor,
                  CNH, certificação de serviço militar, entre outros
                </span>
              </Title>
            </Actions>
            <Card>
